...
const (
	finalizerString = "finalizers.elasticsearchservice.services.k8s.aws/ElasticsearchDomain"
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.ElasticsearchDomain{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ElasticsearchDomain),
	}
}
